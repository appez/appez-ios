...
- (id)initWithAnnotation:(id<MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier {
    if(self = [super initWithAnnotation:annotation reuseIdentifier:reuseIdentifier]) {
        ...
        self.annotationType = PinAnnotationTypeStandard;
...
- (UIImage *)pinAnnotationWithColor:(UIColor *)color {
    ...
    // Shared object
    CustomMapAnnotationView *pn = [CustomMapAnnotationView sharedCache];
    PinAnnotationType type = self.annotationType;
    ...
    // Type Name
    NSString *typeName = @"";
    if (type == PinAnnotationTypeStandard) {
        typeName = @"_standard";
    } else if (type == PinAnnotationTypeDisc) {
        typeName = @"_disc";
    } else if (type == PinAnnotationTypeTag) {
        typeName = @"_tag";
    } else if (type == PinAnnotationTypeTag) {
        typeName = @"_tagStroke";
    }
    ...
    } else if (type == PinAnnotationTypeTagStroke) {
